...
Unidades dentro de cada subdivisión
Cada subdivisión tiene cuatro carpetas:
...
Carpeta de software
Contiene información sobre las herramientas necesarias:

Archivo principal

README.md → Documentación general del proyecto, estructura, integrantes e instrucciones de uso.
